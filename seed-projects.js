...
const projects = [
  {
    ...
    shortDescription:
      "A fully functional portfolio website for Waer Ayman, featuring powerful GSAP animations, modern UI/UX design, and a complete admin dashboard for content management.",
    thumbnail: {
    ...
    sections: {
      ...
      overview: {
        ...
        description:
          "A fully functional portfolio website featuring powerful GSAP animations, modern UI/UX design, and a complete admin dashboard for content management.",
        highlights: [
  ...
  },
  {
    ...
    shortDescription:
      "Modern personal portfolio built with Next.js to showcase academic and professional work. Highlight technical expertise and project case studies.",
    thumbnail: {
    ...
    sections: {
      ...
      overview: {
        ...
        description:
          "Modern personal portfolio built with Next.js to showcase academic and professional work, highlighting technical expertise and project case studies.",
        highlights: [
          "Next.js App Router",
          "MongoDB integration",
  ...
  },
  {
    ...
    shortDescription:
      "A full-featured travel booking platform that allows users to explore tours, view destinations, and book trips through a modern and intuitive web interface.",
    thumbnail: {
  ...
  },
  {
    ...
    shortDescription:
      "A personal portfolio website showcasing skills as a web developer and designer.",
    thumbnail: {
  ...
  },
  {
    ...
    slug: "wonder-pearl",
    shortDescription:
      "A web project designed to showcase unique features and design elements under the name 'Wonder Pearl'.",
    thumbnail: {
  ...
  try {
    ...
    for (const project of projects) {
      try {
        ...
        if (existing) {
          console.log(
            `⚠️  Project "${project.title}" already exists (slug: ${project.slug})`,
          );
