          ...
          <div className="sticky top-0 z-20 flex items-center justify-between px-8 py-4 bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-[var(--border)]">
            <div>
              <h2 className="text-xl font-bold text-[var(--headline)] capitalize flex items-center gap-2">
                {activeSection === "hero" && <MdHome className="text-[var(--accent)]" />}
                {activeSection === "bio" && <MdPerson className="text-[var(--accent)]" />}
                {activeSection === "about" && <MdInfo className="text-[var(--accent)]" />}
                {activeSection === "experience" && <MdWork className="text-[var(--accent)]" />}
                {activeSection === "projects" && <MdFolder className="text-[var(--accent)]" />}
                {activeSection === "header" && <MdMenu className="text-[var(--accent)]" />}
                {activeSection === "settings" && <MdSettings className="text-[var(--accent)]" />}
                Editing {activeSection}
              </h2>
            </div>
            <div className="flex items-center gap-4">
              {message && (
                <span className={`text-sm font-medium ${message.type === 'error' ? 'text-red-500' : 'text-emerald-500'}`}>
                  {message.text}
                </span>
              )}
              <button
