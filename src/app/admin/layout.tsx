...
const AdminThemeToggle = dynamic(
  () => import("@/components/AdminThemeToggle"),
  {
    ssr: false,
  },
);
...
export default function AdminLayout({
  ...
  const _sidebarTextsRef = useRef<HTMLDivElement[]>([]);
          ...
          {menuItems.map((item, _index) => {
            ...
            return (
              ...
              >
                ...
                />
                {sidebarOpen && (
                  <span className="sidebar-text font-medium whitespace-nowrap">
                    {item.name}
                  </span>
                )}
              </Link>
        ...
        <div className="absolute bottom-0 w-full border-t border-white/20 dark:border-white/10">
          ...
          {sidebarOpen && (
            <div className="sidebar-text p-4">
              ...
              <p className="text-[9px] font-secondary text-gray-400 dark:text-gray-500">
          ...
          <div className="p-4 pt-0 space-y-2">
            {sidebarOpen && (
              <div className="border-t border-white/20 dark:border-white/10 mb-2"></div>
            )}
            <Link
              href="/"
              target="_blank"
