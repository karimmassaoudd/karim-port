...
export default function FooterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setMessage({ type: 'error', text: result.error || 'Failed to save footer' });
      }
    } catch (error) {
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="mt-3 text-sm text-gray-600 dark:text-gray-400">Loading footer data...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto">
      {/* Header */}
      <div className="mb-6">
        <h3 className="text-base font-secondary font-bold text-headline mb-2">Footer</h3>
      ...
      <form onSubmit={handleSubmit}>
        <div ref={contentRef} className="backdrop-blur-xl bg-white/70 dark:bg-[var(--card)]/70 rounded-xl shadow-lg border border-white/40 dark:border-white/30 p-6 mb-6">
          ...
          {/* Owner Info */}
          <h3 className="text-xs font-secondary font-bold text-headline mb-6">Owner Information</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              <label className="block text-xs font-secondary font-semibold text-headline mb-2">Owner Name</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-secondary font-semibold text-headline mb-2">Owner Title</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-secondary font-semibold text-headline mb-2">Owner Initial (for avatar)</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-secondary font-semibold text-headline mb-2">Avatar URL (optional)</label>
              <input
                type="text"
                value={formData.ownerAvatarUrl}
                onChange={(e) => setFormData({ ...formData, ownerAvatarUrl: e.target.value })}
          ...
          {/* Contact Info */}
          <h4 className="text-xs font-secondary font-bold text-headline mt-8 mb-4">Contact Information</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
            ...
            <div>
              <label className="block text-xs font-secondary font-semibold text-headline mb-2">Phone</label>
              <input
                type="tel"
            ...
            <div className="md:col-span-2">
              <label className="block text-xs font-secondary font-semibold text-headline mb-2">Location (optional)</label>
              <input
                type="text"
          ...
          <div className="mt-8">
            <div className="flex justify-between items-center mb-4">
              <h4 className="text-xs font-secondary font-bold text-headline">Social Links</h4>
              <button
                type="button"
                onClick={() => {
            ...
            <div className="space-y-3">
              {formData.socialLinks.map((link, index) => (
                <div key={link.id} className="flex items-center gap-3 p-3 backdrop-blur-sm bg-white/50 dark:bg-gray-800/30 rounded-lg border border-white/30 dark:border-white/20">
                  <select
                    value={link.icon}
                    onChange={(e) => {
