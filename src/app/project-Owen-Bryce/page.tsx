        ...
        <main className="min-h-screen bg-[var(--background)]">
          ...
          <section className="reveal-section relative min-h-[90vh] md:min-h-screen overflow-hidden">
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center text-center min-h-[90vh] md:min-h-screen">
              ...
              {/* Down arrow cue */}
              <div
                className="scroll-cue text-[var(--accent)]"
                aria-hidden="true"
              >
              ...
              <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-start">
                ...
                <div>
                  <p className="text-[var(--muted-foreground)] leading-relaxed">
                    ...
                    multiple platforms to maximize audience reach and
                    engagement.
                  </p>
          ...
          {/* Redesigned Section 03: The Challenge */}
          <section className="reveal-section relative py-20 bg-[#070b12] overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="flex flex-col lg:flex-row items-stretch gap-12 lg:gap-20">
                ...
                <div className="flex-1 lg:w-1/2 flex items-center reveal-el text-left">
                  <div className="w-full bg-[#0a0f18]/80 backdrop-blur-xl border border-white/5 rounded-[2rem] p-8 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.3)] relative group">
                    ...
                    <div className="relative z-10 space-y-8">
                      ...
                      <p className="text-sm md:text-base text-[#a0acb9] font-secondary leading-relaxed font-light">
                        Owen Bryce, an emerging folk/indie artist, needed to establish his brand identity and promote his debut EP in a crowded music market. We focused on creating a distinctive visual voice that resonates authentically with his audience.
                      </p>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8 pt-4 border-t border-white/5">
                        <div>
                          ...
                          <p className="text-sm text-white font-secondary">Marketing Strategist & Designer</p>
                        </div>
                        <div>
                          <p className="text-[10px] tracking-widest text-[#a0acb9]/60 font-semibold mb-1 uppercase">Timeline</p>
                          <p className="text-sm text-white font-secondary">8 Weeks</p>
                        </div>
                        <div className="md:col-span-2">
                          <p className="text-[10px] tracking-widest text-[#a0acb9]/60 font-semibold mb-1 uppercase">Platforms</p>
                ...
                <div className="flex gap-6 text-sm">
                  {[
                    ...
                    <button
                      ...
                      className={`relative py-3 -mb-px whitespace-nowrap ${activeTab === t.key
                  ...
                  <div className="grid lg:grid-cols-12 gap-8 items-start">
                    <div className="lg:col-span-6">
                      ...
                      <p className="mt-4 text-[var(--muted-foreground)] leading-relaxed">
                        ...
                        aesthetics, authentic storytelling, and strategic
                        content scheduling.
                      </p>
                      ...
                      <ul className="mt-3 space-y-2 list-disc pl-5 text-sm">
                        <li>
                          Weekly content calendar with consistent posting
                          schedule
                        </li>
                  ...
                  <div className="grid lg:grid-cols-12 gap-8 items-start">
                    <div className="lg:col-span-6 order-2 lg:order-1">
                      ...
                      <p className="mt-4 text-[var(--muted-foreground)] leading-relaxed">
                        ...
                        effective promotional methods from established artists
                      ...
                      <ul className="mt-3 space-y-2 list-disc pl-5 text-sm">
                        <li>
                          Authentic quote collection aligned with the brand
                        </li>
                        <li>
                  ...
                  <div className="space-y-6">
                    <div className="bg-[var(--card)] rounded-xl shadow-md p-6">
                      ...
                      <p className="mt-3 text-[var(--muted-foreground)] text-sm leading-relaxed">
                        ...
                        over the last few weeks. We showed the brand guide and
                        the logos we made, explaining our ideas and choices. Our
                    ...
                    <div className="bg-[var(--card)] rounded-xl shadow-md p-6">
                      ...
                      <p className="mt-3 text-[var(--muted-foreground)] text-sm leading-relaxed">
                        ...
                        asked us some questions about our logo, and we showed
                        him the one Owen Bryce chose. He told us to focus more
                        on his design and make sure it matches the same style
                        and font. We also asked about the website design we’re
                        making for him. He said we need to understand what style
                        and colours he likes so he can see how our work fits his
                        vision.
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="pop-on-scroll bg-[var(--card)] rounded-xl shadow-md overflow-hidden">
                        ...
                        <div className="p-5">
                          ...
                          <p className="mt-2 text-sm text-[var(--muted-foreground)]">
                            Minimalist design with strong visual impact,
                            featuring clear typography and natural elements.
                          </p>
                        </div>
                      </div>
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="pop-on-scroll mt-10 md:mt-14 bg-[var(--card)] rounded-xl shadow-md p-6 md:p-8">
                <p className="font-primary text-lg md:text-xl leading-relaxed text-[var(--accent)]">
                  ...
                  simple music drop to a comprehensive brand launch. The
                  cohesive approach across platforms helped me connect with my
                  audience in a meaningful way and establish a strong foundation
                  for my music career."
                </p>
