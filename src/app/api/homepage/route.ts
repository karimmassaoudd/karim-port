          ...
          items: [
            {
              ...
              description:
                "Discover what truly matters to users through empathy and observation.",
              fullDescription:
                "Plan and conduct interviews, gather meaningful insights, and synthesize findings to uncover real user needs. By understanding motivations and pain points, we guide design decisions that result in intuitive and impactful digital experiences.",
            },
            {
              id: 2,
              ...
              fullDescription:
                "Analyze user feedback, patterns, and behaviors to identify opportunities for improvement. Research findings become the foundation for design choices that enhance usability, clarity, and engagement.",
            },
            {
              id: 3,
              ...
              fullDescription:
                "Build interactive prototypes to visualize concepts and gather user feedback early. Testing and iteration ensure designs are functional, accessible, and aligned with user expectations.",
            },
            {
              id: 4,
              ...
              fullDescription:
                "Apply human-centered principles to craft experiences that not only look good but also solve real problems. Every design decision is driven by empathy, usability, and measurable value..",
            },
          ],
        },
