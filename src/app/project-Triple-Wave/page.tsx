                ...
                <div className="mx-auto grid w-full max-w-6xl grid-cols-1 lg:grid-cols-2 gap-10 items-center justify-items-center">
                  <div className="col-span-1 text-center">
                    ...
                    <p className="reveal-el text-[var(--secondary-text)] text-lg md:text-xl leading-relaxed max-w-md mx-auto text-center">
                      A friendly guide for international students in Eindhoven
                      find housing, get around, manage finances, and discover
                      local events.
                    </p>
                  </div>
                      ...
                      <div className="relative z-10 space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8 pt-4 border-t border-white/5">
                          <div>
                            ...
                            <p className="text-sm text-white font-secondary">UX/UI Design & Front-end</p>
                          </div>
                          <div>
                            <p className="text-[10px] tracking-widest text-[#a0acb9]/60 font-semibold mb-1 uppercase">Type</p>
                            <p className="text-sm text-white font-secondary">Student information website</p>
                          </div>
                          <div className="md:col-span-2">
                            ...
                            <p className="text-sm text-white font-secondary leading-relaxed">
                              Housing options, Transport guides, Budgeting tips, Local events
                            </p>
                          </div>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
                  <div className="pop-on-scroll rounded-2xl border border-black/10 dark:border-white/10 bg-white/80 dark:bg-[var(--Secondary-Background)]/70 shadow-sm p-6">
                    ...
                    <ul className="space-y-2 text-sm text-[var(--secondary-text)]">
                      ...
                      <li>
                        Built reusable sections for services, projects, and
                        contact details.
                      </li>
                      <li>
                  ...
                  <div className="pop-on-scroll rounded-2xl border border-black/10 dark:border-white/10 bg-white/80 dark:bg-[var(--Secondary-Background)]/70 shadow-sm p-6">
                    ...
                    <ul className="space-y-2 text-sm text-[var(--secondary-text)]">
                      ...
                      <li>
                        Seamless user flow with engaging transitions and
                        clarity.
                      </li>
                    </ul>
                  </div>
            ...
            <section className="reveal-section relative w-full py-16 md:py-20">
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <p className="mt-3 text-center text-sm md:text-base text-[var(--secondary-text)] max-w-3xl mx-auto">
                  Swipe through vibrant neighborhoods, iconic landmarks, and
                  hidden gems that give Eindhoven its character.
                </p>
            ...
            <section className="reveal-section relative w-full py-16 md:py-20">
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <p className="text-sm text-[var(--secondary-text)] mb-4">
                  Choose a destination below — the live website or the design
                  file
                </p>
