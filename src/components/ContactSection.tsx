...
const FormField: React.FC<FormFieldProps> = ({
  ...
  <div className="mb-6">
    ...
    <div
      className={`p-1 rounded-[var(--radius)] bg-[var(--accent)] ${className ?? ""}`}
    >
      {children}
    </div>
  </div>
...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section
      className="reveal-section py-12 sm:py-16 md:py-20 bg-[var(--background)] font-[var(--font-secondary)] min-h-screen relative"
      id="contact"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-4">
          {/* Contact Me Label */}
          <h4 className="body-text-b text-right reveal-el">Contact Me</h4>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-start">
          ...
          <div className="flex flex-col items-center justify-center justify-self-center self-center pt-6 sm:pt-10 pb-12 sm:pb-16 lg:pb-0 lg:pt-0 reveal-el">
            ...
            <div className="flex justify-center mb-8 pop-on-scroll">
              ...
              />
              <IconLink
                href="https://github.com/ic0nk"
                icon={FaGithub}
                label="GitHub"
              />
              <IconLink
                href="mailto:karimmassoud668@gmail.com"
                icon={IoMdMail}
                label="Email"
              />
            </div>
