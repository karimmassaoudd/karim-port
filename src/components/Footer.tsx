...
export const Footer: FC = () => {
  ...
  const IconLink = ({
    ...
    <a
      ...
      className="magnetic-el pop-on-scroll group flex h-12 w-12 items-center justify-center rounded-full border border-white/20 bg-white/5 text-[var(--text)] transition duration-300 hover:-translate-y-1 hover:border-white/40 hover:bg-white/15"
      aria-label={label}
      title={label}
    >
      ...
      <section className="reveal-section relative mx-auto flex w-full max-w-6xl flex-col gap-16 px-6 sm:px-8">
        <div className="grid gap-12 md:grid-cols-[1.2fr_1fr_1fr]">
          <div className="space-y-6">
            <div className="reveal-el flex items-center gap-4">
              ...
              <div>
                ...
                <p className="split-text text-2xl font-semibold tracking-wide text-[var(--text)]">
                  {displayName}
                </p>
              </div>
            </div>
            <p className="reveal-el max-w-lg text-sm leading-relaxed text-[var(--text)]">
              ...
              crafting immersive user experiences, thoughtful brand systems, and
          ...
          <div className="space-y-5">
            ...
            <Link
              href="/#contact"
              className="magnetic-el glow-bleed inline-flex items-center justify-center rounded-full border border-white/20 bg-white/10 px-6 py-3 text-xs uppercase tracking-[0.25em] text-[var(--text)] transition hover:border-white/40 hover:bg-white/20 pop-on-scroll"
            >
              Start a project
            </Link>
          </div>
